                      ...
                      Row(
                        children: [
                          Align(
                            ...
                            child: Text(widget._bean.user,style: TextStyle(color: BColors.COMMON_TEXT_GREY,fontSize: BFontSize.FONT_SIZE_SAMLL),),
                          ),
                          Flexible(fit: FlexFit.tight, child: SizedBox()),
                          Align(
                            alignment: Alignment.centerLeft,
                            child: Text("热度 "+widget._bean.like.toString(),style: TextStyle(color: BColors.COMMON_TEXT_GREY,fontSize: BFontSize.FONT_SIZE_SAMLL),),
                          ),
                          Align(
                            child: Container(
