...
/// See also:
///
///  * [RightButtonTabBar], which displays a row of tabs.
///  * [RightButtonTabBarView], which displays a widget for the currently selected tab.
///  * [RightButtonTabBar.indicator], which defines the appearance of the selected tab
///    indicator relative to the tab's bounds.
enum RightTabBarIndicatorSize {
  ...
  ///
  /// This value is used to align the tab's label, typically a [RightButtonTab]
  /// widget's text or icon, with the selected tab indicator.
  label,
}

/// A material design [RightButtonTabBar] tab.
///
...
///  * [RightButtonTabBar], which displays a row of tabs.
///  * [RightButtonTabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [RightButtonTabBar] and a [RightButtonTabBarView].
///  * <https://material.io/design/components/tabs.html>
class RightButtonTab extends StatelessWidget {
  /// Creates a material design [RightButtonTabBar] tab.
  ///
  /// At least one of [text], [icon], and [child] must be non-null. The [text]
  /// and [child] arguments must not be used at the same time. The
  /// [iconMargin] is only useful when [icon] and either one of [text] or
  /// [child] is non-null.
  const RightButtonTab({
    Key? key,
    this.text,
    this.icon,
    this.iconMargin = const EdgeInsets.only(bottom: 0),
    this.child,
  ...
  Widget _buildLabelText() {
    return child ?? Text(text!, softWrap: false, overflow: TextOverflow.fade,style: TextStyle(fontSize: BFontSize.FONT_SIZE_NORMAL),);
  }
...
class _IndicatorPainter extends CustomPainter {
  ...
  final RightTabBarIndicatorSize? indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == RightTabBarIndicatorSize.label) {
...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _RightButtonTabBarState tabBar;
...
/// conjunction with a [RightButtonTabBarView].
///
...
/// [RightButtonTabBarView.children] list.
///
...
/// This sample shows the implementation of [RightButtonTabBar] and [RightButtonTabBarView] using a [DefaultTabController].
/// Each [RightButtonTab] corresponds to a child of the [RightButtonTabBarView] in the order they are written.
///
/// ```dart
/// Widget build(BuildContext context) {
...
/// [RightButtonTabBar] can also be implmented by using a [TabController] which provides more options
/// to control the behavior of the [RightButtonTabBar] and [RightButtonTabBarView]. This can be used instead of
...
/// See also:
///
///  * [RightButtonTabBarView], which displays page views that correspond to each tab.
///  * [RightButtonTabBar], which is used to display the [RightButtonTab] that corresponds to each page of the [RightButtonTabBarView].
class RightButtonTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [RightButtonTab] widgets.
  ///
  /// The length of this list must match the [controller]'s [TabController.length]
  /// and the length of the [RightButtonTabBarView.children] list.
  ...
  /// and the entire [RightButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// the indicator with the tab's text for [RightButtonTab] widgets and all but the
  /// shortest [RightButtonTab.text] values.
  ///
  ...
  /// is [RightTabBarIndicatorSize.tab] the tab's bounds are as wide as the space
  /// occupied by the tab in the tab bar. If [indicatorSize] is
  /// [RightTabBarIndicatorSize.label], then the tab's bounds are only as wide as
  ...
  /// tab's overall bounds if [indicatorSize] is [RightTabBarIndicatorSize.tab]
  /// (the default) or relative to the bounds of the tab's widget if
  /// [indicatorSize] is [RightTabBarIndicatorSize.label].
  ///
  ...
  /// An optional callback that's called when the [RightButtonTabBar] is tapped.
  ///
  ...
  /// How the [RightButtonTabBar]'s scroll view should respond to user input.
  ///
  ...
  Size get preferredSize {
    for (final Widget item in tabs) {
      if (item is RightButtonTab) {
        final RightButtonTab tab = item;
  ...
  @override
  _RightButtonTabBarState createState() => _RightButtonTabBarState();
}

class _RightButtonTabBarState extends State<RightButtonTabBar> {
  ...
  void _initIndicatorPainter() {
    _indicatorPainter = !_controllerIsValid ? null : _IndicatorPainter(
      ...
      indicatorSize: widget.indicatorSize ?? TabBarTheme.of(context).indicatorSize as RightTabBarIndicatorSize?,
  ...
  @override
  void didUpdateWidget(RightButtonTabBar oldWidget) {
...
/// selected tab.
///
/// This widget is typically used in conjunction with a [RightButtonTabBar].
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=POtoEH-5l40}
///
...
/// [children] list and the length of the [RightButtonTabBar.tabs] list.
///
/// To see a sample implementation, visit the [TabController] documentation.
class RightButtonTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const RightButtonTabBarView({
    Key? key,
  ...
  /// One widget per tab.
  ///
  /// Its length must match the length of the [RightButtonTabBar.tabs]
  ...
  @override
  _RightButtonTabBarViewState createState() => _RightButtonTabBarViewState();
}

class _RightButtonTabBarViewState extends State<RightButtonTabBarView> {
  TabController? _controller;
  ...
  @override
  void didUpdateWidget(RightButtonTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.controller != oldWidget.controller)
      _updateTabController();
